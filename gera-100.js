...
for ( let l = 0; l < 9+0 ; l++ ) {
    ...
    while (true) {
        ...
        //console.log("01 : ", iteracao, l, num_sort);
        if ( existeLinGr(l,num_sort)  == true ) continue;
        if ( existeCEL3x3(l,num_sort) == true ) continue;
        if ( existeColGr(l,num_sort)  == true ) continue;
        ma[l] = num_sort;
        break;
    }
}
...
function existeLinGr (indice, numero) {
 ...
 function existeColGr (indice, numero) {
    liscel = [ [0,  3, 6,27,30,33,54,57,60], [1,  4, 7,28,31,34,55,58,61], [2,  5, 8,29,32,35,56,59,62],
